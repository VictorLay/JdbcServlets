...
import com.victor.latyshey.beans.Role;
...
public class UserDaoImpl implements UserDAO {
  ...
  private static final String ILLEGAL_ID = "User with such ID isn't exist.";
  ...
  public User read(String signLogin, String password) throws DaoException {
    try (PreparedStatement statement = ConnectionPool.getInstance().getConnection()
        .prepareStatement(READ_USER_BY_LOGIN_AND_PASSWORD)) {
  ...
  public User read(Integer id) throws DaoException {
    try (PreparedStatement statement = ConnectionPool.getInstance().getConnection()
      ...
      if (query.next()) {
        ...
        throw new DaoException(ILLEGAL_ID);
      }
    } catch (SQLException | PoolException e) {
      throw new DaoException(e);
    }
